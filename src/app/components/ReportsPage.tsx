...
export function ReportsPage() {
  ...
  const generatePDF = async () => {
    confirm({
      ...
      message: `Are you sure you want to generate a financial report for ${format(reportData.monthDate, 'MMMM yyyy')}?`,
  ...
  return (
    <div className="space-y-6 flex-1 flex flex-col md:min-h-0 md:h-[calc(100vh-8rem)]">
      <ReportsTutorial />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 flex-1 md:min-h-0">
        {/* Settings Sidebar */}
        ...
        <div className="col-span-2 bg-zinc-950/50 rounded-xl p-4 sm:p-6 border border-zinc-800 overflow-x-auto md:overflow-auto shadow-inner">
          <div className="w-fit min-w-[794px] mx-auto flex flex-col items-center pb-8">
